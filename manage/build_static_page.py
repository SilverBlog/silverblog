...
def build(github_mode):
    ...
    content, row = page.build_index(1, system_config, page_list, menu_list, html_static)
    ...
    if row != 1:
        ...
        for page_id in range(2, row + 1):
            content, row = page.build_index(page_id, system_config, page_list, menu_list, html_static)
